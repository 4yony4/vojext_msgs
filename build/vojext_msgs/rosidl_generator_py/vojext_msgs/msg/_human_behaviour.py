    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'vojext_msgs.msg.HumanBehaviour')
            logger.debug(
            ...
            from vojext_msgs.msg import HumanGraspingStrategies
...
class HumanBehaviour(metaclass=Metaclass_HumanBehaviour):
    ...
    _fields_and_field_types = {
        ...
        'body_posture': 'string',
        'humamgrasping_list': 'sequence<vojext_msgs/HumanGraspingStrategies>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['vojext_msgs', 'msg'], 'HumanGraspingStrategies')),  # noqa: E501
    )
