...
bool vojext_msgs__msg__robot_hand_kinematic__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vojext_msgs.msg._robot_hand_kinematic.RobotHandKinematic", full_classname_dest, 56) == 0);
  }
  vojext_msgs__msg__RobotHandKinematic * ros_message = _ros_message;
  {  // header
...
PyObject * vojext_msgs__msg__robot_hand_kinematic__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vojext_msgs.msg._robot_hand_kinematic");
