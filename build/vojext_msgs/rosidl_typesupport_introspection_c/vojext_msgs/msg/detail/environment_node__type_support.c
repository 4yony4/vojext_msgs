...
#include <stddef.h>
#include "vojext_msgs/msg/detail/environment_node__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vojext_msgs__msg__EnvironmentNode__init(message_memory);
}

void EnvironmentNode__rosidl_typesupport_introspection_c__EnvironmentNode_fini_function(void * message_memory)
{
  vojext_msgs__msg__EnvironmentNode__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember EnvironmentNode__rosidl_typesupport_introspection_c__EnvironmentNode_message_member_array[4] = {
  {
    ...
    offsetof(vojext_msgs__msg__EnvironmentNode, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__EnvironmentNode, image_rgb),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__EnvironmentNode, image_3d),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__EnvironmentNode, class_name),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers EnvironmentNode__rosidl_typesupport_introspection_c__EnvironmentNode_message_members = {
  ...
  4,  // number of fields
  sizeof(vojext_msgs__msg__EnvironmentNode),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vojext_msgs, msg, EnvironmentNode)() {
