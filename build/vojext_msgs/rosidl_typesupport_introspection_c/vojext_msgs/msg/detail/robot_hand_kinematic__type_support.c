  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vojext_msgs__msg__RobotHandKinematic__init(message_memory);
}

void RobotHandKinematic__rosidl_typesupport_introspection_c__RobotHandKinematic_fini_function(void * message_memory)
{
  vojext_msgs__msg__RobotHandKinematic__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember RobotHandKinematic__rosidl_typesupport_introspection_c__RobotHandKinematic_message_member_array[5] = {
  {
    ...
    offsetof(vojext_msgs__msg__RobotHandKinematic, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__RobotHandKinematic, position),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__RobotHandKinematic, velocity),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__RobotHandKinematic, acceleration),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__RobotHandKinematic, forces),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers RobotHandKinematic__rosidl_typesupport_introspection_c__RobotHandKinematic_message_members = {
  ...
  5,  // number of fields
  sizeof(vojext_msgs__msg__RobotHandKinematic),
