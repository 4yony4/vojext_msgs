  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vojext_msgs__msg__GraspFacts__init(message_memory);
}

void GraspFacts__rosidl_typesupport_introspection_c__GraspFacts_fini_function(void * message_memory)
{
  vojext_msgs__msg__GraspFacts__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember GraspFacts__rosidl_typesupport_introspection_c__GraspFacts_message_member_array[4] = {
  {
    ...
    offsetof(vojext_msgs__msg__GraspFacts, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__GraspFacts, grasp_type),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__GraspFacts, grasp_location),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__GraspFacts, grasp_dimension),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GraspFacts__rosidl_typesupport_introspection_c__GraspFacts_message_members = {
  ...
  4,  // number of fields
  sizeof(vojext_msgs__msg__GraspFacts),
