  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vojext_msgs__msg__HumanGraspingStrategies__init(message_memory);
}
...
{
  vojext_msgs__msg__HumanGraspingStrategies__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember HumanGraspingStrategies__rosidl_typesupport_introspection_c__HumanGraspingStrategies_message_member_array[3] = {
  {
    ...
    offsetof(vojext_msgs__msg__HumanGraspingStrategies, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__HumanGraspingStrategies, type),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__HumanGraspingStrategies, location),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers HumanGraspingStrategies__rosidl_typesupport_introspection_c__HumanGraspingStrategies_message_members = {
  ...
  3,  // number of fields
  sizeof(vojext_msgs__msg__HumanGraspingStrategies),
