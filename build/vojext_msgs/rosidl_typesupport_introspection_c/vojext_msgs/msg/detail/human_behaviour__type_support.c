...
#include <stddef.h>
#include "vojext_msgs/msg/detail/human_behaviour__rosidl_typesupport_introspection_c.h"
...
#include "vojext_msgs/msg/human_grasping_strategies.h"
// Member `humamgrasping_list`
#include "vojext_msgs/msg/detail/human_grasping_strategies__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vojext_msgs__msg__HumanBehaviour__init(message_memory);
}

void HumanBehaviour__rosidl_typesupport_introspection_c__HumanBehaviour_fini_function(void * message_memory)
{
  vojext_msgs__msg__HumanBehaviour__fini(message_memory);
}
...
{
  const vojext_msgs__msg__HumanGraspingStrategies__Sequence * member =
    (const vojext_msgs__msg__HumanGraspingStrategies__Sequence *)(untyped_member);
  return member->size;
}
...
{
  vojext_msgs__msg__HumanGraspingStrategies__Sequence * member =
    (vojext_msgs__msg__HumanGraspingStrategies__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  vojext_msgs__msg__HumanGraspingStrategies__Sequence * member =
    (vojext_msgs__msg__HumanGraspingStrategies__Sequence *)(untyped_member);
  vojext_msgs__msg__HumanGraspingStrategies__Sequence__fini(member);
  return vojext_msgs__msg__HumanGraspingStrategies__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember HumanBehaviour__rosidl_typesupport_introspection_c__HumanBehaviour_message_member_array[3] = {
  {
    ...
    offsetof(vojext_msgs__msg__HumanBehaviour, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__HumanBehaviour, body_posture),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__HumanBehaviour, humamgrasping_list),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers HumanBehaviour__rosidl_typesupport_introspection_c__HumanBehaviour_message_members = {
  ...
  3,  // number of fields
  sizeof(vojext_msgs__msg__HumanBehaviour),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vojext_msgs, msg, HumanBehaviour)() {
  ...
  HumanBehaviour__rosidl_typesupport_introspection_c__HumanBehaviour_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vojext_msgs, msg, HumanGraspingStrategies)();
