...
#include <stddef.h>
#include "vojext_msgs/msg/detail/neuromorphic_sensing__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vojext_msgs__msg__NeuromorphicSensing__init(message_memory);
}

void NeuromorphicSensing__rosidl_typesupport_introspection_c__NeuromorphicSensing_fini_function(void * message_memory)
{
  vojext_msgs__msg__NeuromorphicSensing__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember NeuromorphicSensing__rosidl_typesupport_introspection_c__NeuromorphicSensing_message_member_array[3] = {
  {
    ...
    offsetof(vojext_msgs__msg__NeuromorphicSensing, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__NeuromorphicSensing, point1_speed),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__NeuromorphicSensing, point2_speed),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers NeuromorphicSensing__rosidl_typesupport_introspection_c__NeuromorphicSensing_message_members = {
  ...
  3,  // number of fields
  sizeof(vojext_msgs__msg__NeuromorphicSensing),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vojext_msgs, msg, NeuromorphicSensing)() {
