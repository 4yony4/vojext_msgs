...
#ifndef VOJEXT_MSGS__MSG__DETAIL__PERSON__STRUCT_HPP_
#define VOJEXT_MSGS__MSG__DETAIL__PERSON__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__vojext_msgs__msg__Person __attribute__((deprecated))
#else
# define DEPRECATED__vojext_msgs__msg__Person __declspec(deprecated)
#endif
...
struct Person_
{
  ...
  using _left_hand_type =
    std::vector<vojext_msgs::msg::Hand_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<vojext_msgs::msg::Hand_<ContainerAllocator>>>;
  ...
  Type & set__left_hand(
    const std::vector<vojext_msgs::msg::Hand_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<vojext_msgs::msg::Hand_<ContainerAllocator>>> & _arg)
  {
    this->left_hand = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    vojext_msgs::msg::Person_<ContainerAllocator> *;
  using ConstRawPtr =
    const vojext_msgs::msg::Person_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<vojext_msgs::msg::Person_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<vojext_msgs::msg::Person_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      vojext_msgs::msg::Person_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<vojext_msgs::msg::Person_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<vojext_msgs::msg::Person_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<vojext_msgs::msg::Person_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<vojext_msgs::msg::Person_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__vojext_msgs__msg__Person
    std::shared_ptr<vojext_msgs::msg::Person_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__vojext_msgs__msg__Person
    std::shared_ptr<vojext_msgs::msg::Person_<ContainerAllocator> const>
...
using Person =
  vojext_msgs::msg::Person_<std::allocator<void>>;
...
#endif  // VOJEXT_MSGS__MSG__DETAIL__PERSON__STRUCT_HPP_
