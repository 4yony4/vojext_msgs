...
{
  new (message_memory) vojext_msgs::msg::RobotHandKinematic(_init);
}

void RobotHandKinematic_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vojext_msgs::msg::RobotHandKinematic *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotHandKinematic_message_member_array[5] = {
  {
    ...
    offsetof(vojext_msgs::msg::RobotHandKinematic, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::RobotHandKinematic, position),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::RobotHandKinematic, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::RobotHandKinematic, acceleration),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::RobotHandKinematic, forces),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotHandKinematic_message_members = {
  ...
  5,  // number of fields
  sizeof(vojext_msgs::msg::RobotHandKinematic),
...
get_message_type_support_handle<vojext_msgs::msg::RobotHandKinematic>()
{
  return &::vojext_msgs::msg::rosidl_typesupport_introspection_cpp::RobotHandKinematic_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vojext_msgs, msg, RobotHandKinematic)() {
  return &::vojext_msgs::msg::rosidl_typesupport_introspection_cpp::RobotHandKinematic_message_type_support_handle;
}
