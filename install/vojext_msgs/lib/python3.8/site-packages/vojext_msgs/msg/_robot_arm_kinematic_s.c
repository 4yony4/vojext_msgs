...
bool vojext_msgs__msg__robot_arm_kinematic__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vojext_msgs.msg._robot_arm_kinematic.RobotArmKinematic", full_classname_dest, 54) == 0);
  }
  vojext_msgs__msg__RobotArmKinematic * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RobotArmKinematic */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vojext_msgs.msg._robot_arm_kinematic");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotArmKinematic");
