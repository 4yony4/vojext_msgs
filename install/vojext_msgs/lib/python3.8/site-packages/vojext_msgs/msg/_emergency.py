...
class Emergency(metaclass=Metaclass_Emergency):
    ...
    def __init__(self, **kwargs):
        ...
        self.emergency_label = kwargs.get('emergency_label', str())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.emergency_label != other.emergency_label:
            return False
        return True
    ...
    def emergency_label(self):
        """Message field 'emergency_label'."""
        return self._emergency_label

    @emergency_label.setter
    def emergency_label(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'emergency_label' field must be of type 'str'"
        self._emergency_label = value
