...
bool vojext_msgs__msg__vjxoutput__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vojext_msgs.msg._vjxoutput.Vjxoutput", full_classname_dest, 36) == 0);
  }
  vojext_msgs__msg__Vjxoutput * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of Vjxoutput */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vojext_msgs.msg._vjxoutput");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Vjxoutput");
