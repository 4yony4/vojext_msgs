...
{
  new (message_memory) vojext_msgs::msg::GraspTrajectory(_init);
}

void GraspTrajectory_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vojext_msgs::msg::GraspTrajectory *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GraspTrajectory_message_member_array[4] = {
  {
    ...
    offsetof(vojext_msgs::msg::GraspTrajectory, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::GraspTrajectory, ee_frame_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::GraspTrajectory, hand_poses),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::GraspTrajectory, fingers_states),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GraspTrajectory_message_members = {
  ...
  4,  // number of fields
  sizeof(vojext_msgs::msg::GraspTrajectory),
...
get_message_type_support_handle<vojext_msgs::msg::GraspTrajectory>()
{
  return &::vojext_msgs::msg::rosidl_typesupport_introspection_cpp::GraspTrajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vojext_msgs, msg, GraspTrajectory)() {
  return &::vojext_msgs::msg::rosidl_typesupport_introspection_cpp::GraspTrajectory_message_type_support_handle;
}
