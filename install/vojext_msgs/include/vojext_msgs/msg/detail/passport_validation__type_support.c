...
#include <stddef.h>
#include "vojext_msgs/msg/detail/passport_validation__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vojext_msgs__msg__PassportValidation__init(message_memory);
}

void PassportValidation__rosidl_typesupport_introspection_c__PassportValidation_fini_function(void * message_memory)
{
  vojext_msgs__msg__PassportValidation__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember PassportValidation__rosidl_typesupport_introspection_c__PassportValidation_message_member_array[3] = {
  {
    ...
    offsetof(vojext_msgs__msg__PassportValidation, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__PassportValidation, passport_num),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__PassportValidation, result),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers PassportValidation__rosidl_typesupport_introspection_c__PassportValidation_message_members = {
  ...
  3,  // number of fields
  sizeof(vojext_msgs__msg__PassportValidation),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vojext_msgs, msg, PassportValidation)() {
