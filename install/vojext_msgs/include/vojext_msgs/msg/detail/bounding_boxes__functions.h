...
#ifndef VOJEXT_MSGS__MSG__DETAIL__BOUNDING_BOXES__FUNCTIONS_H_
#define VOJEXT_MSGS__MSG__DETAIL__BOUNDING_BOXES__FUNCTIONS_H_
 ...
 * calls
 * vojext_msgs__msg__BoundingBoxes__init().
...
/**
 * It calls
 * vojext_msgs__msg__BoundingBoxes__fini()
 ...
 * vojext_msgs__msg__BoundingBoxes__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * vojext_msgs__msg__BoundingBoxes__Sequence__fini()
 * on the array,
...
#endif  // VOJEXT_MSGS__MSG__DETAIL__BOUNDING_BOXES__FUNCTIONS_H_
