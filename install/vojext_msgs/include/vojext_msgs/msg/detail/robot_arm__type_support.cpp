...
{
  new (message_memory) vojext_msgs::msg::RobotArm(_init);
}

void RobotArm_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vojext_msgs::msg::RobotArm *>(message_memory);
  typed_message->~RobotArm();
}

size_t size_function__RobotArm__robotarmkinematic_list(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<vojext_msgs::msg::RobotArmKinematic> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<vojext_msgs::msg::RobotArmKinematic> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<vojext_msgs::msg::RobotArmKinematic> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotArm_message_member_array[3] = {
  {
    ...
    offsetof(vojext_msgs::msg::RobotArm, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::RobotArm, state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<vojext_msgs::msg::RobotArmKinematic>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::RobotArm, robotarmkinematic_list),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotArm_message_members = {
  ...
  3,  // number of fields
  sizeof(vojext_msgs::msg::RobotArm),
...
get_message_type_support_handle<vojext_msgs::msg::RobotArm>()
{
  return &::vojext_msgs::msg::rosidl_typesupport_introspection_cpp::RobotArm_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vojext_msgs, msg, RobotArm)() {
  return &::vojext_msgs::msg::rosidl_typesupport_introspection_cpp::RobotArm_message_type_support_handle;
}
