...
#include <stddef.h>
#include "vojext_msgs/msg/detail/robot_low_latency_corrections__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vojext_msgs__msg__RobotLowLatencyCorrections__init(message_memory);
}
...
{
  vojext_msgs__msg__RobotLowLatencyCorrections__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember RobotLowLatencyCorrections__rosidl_typesupport_introspection_c__RobotLowLatencyCorrections_message_member_array[2] = {
  {
    ...
    offsetof(vojext_msgs__msg__RobotLowLatencyCorrections, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__RobotLowLatencyCorrections, action),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers RobotLowLatencyCorrections__rosidl_typesupport_introspection_c__RobotLowLatencyCorrections_message_members = {
  ...
  2,  // number of fields
  sizeof(vojext_msgs__msg__RobotLowLatencyCorrections),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vojext_msgs, msg, RobotLowLatencyCorrections)() {
