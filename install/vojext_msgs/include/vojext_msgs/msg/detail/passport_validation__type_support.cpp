...
{
  new (message_memory) vojext_msgs::msg::PassportValidation(_init);
}

void PassportValidation_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vojext_msgs::msg::PassportValidation *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PassportValidation_message_member_array[3] = {
  {
    ...
    offsetof(vojext_msgs::msg::PassportValidation, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::PassportValidation, passport_num),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::PassportValidation, result),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PassportValidation_message_members = {
  ...
  3,  // number of fields
  sizeof(vojext_msgs::msg::PassportValidation),
...
get_message_type_support_handle<vojext_msgs::msg::PassportValidation>()
{
  return &::vojext_msgs::msg::rosidl_typesupport_introspection_cpp::PassportValidation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vojext_msgs, msg, PassportValidation)() {
  return &::vojext_msgs::msg::rosidl_typesupport_introspection_cpp::PassportValidation_message_type_support_handle;
}
