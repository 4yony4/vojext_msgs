...
{
  new (message_memory) vojext_msgs::msg::ClusteredObject(_init);
}

void ClusteredObject_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vojext_msgs::msg::ClusteredObject *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ClusteredObject_message_member_array[4] = {
  {
    ...
    offsetof(vojext_msgs::msg::ClusteredObject, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::ClusteredObject, clustered_point_cloud),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::ClusteredObject, id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::ClusteredObject, sclass),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ClusteredObject_message_members = {
  ...
  4,  // number of fields
  sizeof(vojext_msgs::msg::ClusteredObject),
...
get_message_type_support_handle<vojext_msgs::msg::ClusteredObject>()
{
  return &::vojext_msgs::msg::rosidl_typesupport_introspection_cpp::ClusteredObject_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vojext_msgs, msg, ClusteredObject)() {
  return &::vojext_msgs::msg::rosidl_typesupport_introspection_cpp::ClusteredObject_message_type_support_handle;
}
