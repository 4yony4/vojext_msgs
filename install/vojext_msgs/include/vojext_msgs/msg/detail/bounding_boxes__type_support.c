...
#include <stddef.h>
#include "vojext_msgs/msg/detail/bounding_boxes__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vojext_msgs__msg__BoundingBoxes__init(message_memory);
}

void BoundingBoxes__rosidl_typesupport_introspection_c__BoundingBoxes_fini_function(void * message_memory)
{
  vojext_msgs__msg__BoundingBoxes__fini(message_memory);
}

size_t BoundingBoxes__rosidl_typesupport_introspection_c__size_function__BoundingBox__bounding_boxes(
  const void * untyped_member)
{
  const vojext_msgs__msg__BoundingBox__Sequence * member =
    (const vojext_msgs__msg__BoundingBox__Sequence *)(untyped_member);
  return member->size;
}
...
{
  vojext_msgs__msg__BoundingBox__Sequence * member =
    (vojext_msgs__msg__BoundingBox__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  vojext_msgs__msg__BoundingBox__Sequence * member =
    (vojext_msgs__msg__BoundingBox__Sequence *)(untyped_member);
  vojext_msgs__msg__BoundingBox__Sequence__fini(member);
  return vojext_msgs__msg__BoundingBox__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember BoundingBoxes__rosidl_typesupport_introspection_c__BoundingBoxes_message_member_array[3] = {
  {
    ...
    offsetof(vojext_msgs__msg__BoundingBoxes, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__BoundingBoxes, image_header),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__BoundingBoxes, bounding_boxes),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers BoundingBoxes__rosidl_typesupport_introspection_c__BoundingBoxes_message_members = {
  ...
  3,  // number of fields
  sizeof(vojext_msgs__msg__BoundingBoxes),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vojext_msgs, msg, BoundingBoxes)() {
