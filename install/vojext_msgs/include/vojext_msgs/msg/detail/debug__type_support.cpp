...
{
  new (message_memory) vojext_msgs::msg::Debug(_init);
}

void Debug_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vojext_msgs::msg::Debug *>(message_memory);
  typed_message->~Debug();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Debug_message_member_array[2] = {
  {
    ...
    offsetof(vojext_msgs::msg::Debug, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs::msg::Debug, msg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<vojext_msgs::msg::Debug>()
{
  return &::vojext_msgs::msg::rosidl_typesupport_introspection_cpp::Debug_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vojext_msgs, msg, Debug)() {
  return &::vojext_msgs::msg::rosidl_typesupport_introspection_cpp::Debug_message_type_support_handle;
}
