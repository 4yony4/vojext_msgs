...
#ifndef VOJEXT_MSGS__MSG__DETAIL__FATIGUE_ANALYSIS__STRUCT_HPP_
#define VOJEXT_MSGS__MSG__DETAIL__FATIGUE_ANALYSIS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__vojext_msgs__msg__FatigueAnalysis __attribute__((deprecated))
#else
# define DEPRECATED__vojext_msgs__msg__FatigueAnalysis __declspec(deprecated)
#endif
...
struct FatigueAnalysis_
{
  ...
  // pointer types
  using RawPtr =
    vojext_msgs::msg::FatigueAnalysis_<ContainerAllocator> *;
  using ConstRawPtr =
    const vojext_msgs::msg::FatigueAnalysis_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<vojext_msgs::msg::FatigueAnalysis_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<vojext_msgs::msg::FatigueAnalysis_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      vojext_msgs::msg::FatigueAnalysis_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<vojext_msgs::msg::FatigueAnalysis_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<vojext_msgs::msg::FatigueAnalysis_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<vojext_msgs::msg::FatigueAnalysis_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<vojext_msgs::msg::FatigueAnalysis_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__vojext_msgs__msg__FatigueAnalysis
    std::shared_ptr<vojext_msgs::msg::FatigueAnalysis_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__vojext_msgs__msg__FatigueAnalysis
    std::shared_ptr<vojext_msgs::msg::FatigueAnalysis_<ContainerAllocator> const>
...
using FatigueAnalysis =
  vojext_msgs::msg::FatigueAnalysis_<std::allocator<void>>;
...
#endif  // VOJEXT_MSGS__MSG__DETAIL__FATIGUE_ANALYSIS__STRUCT_HPP_
