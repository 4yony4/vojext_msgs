...
#include <stddef.h>
#include "vojext_msgs/msg/detail/person__rosidl_typesupport_introspection_c.h"
...
// Member `left_hand`
// Member `right_hand`
#include "vojext_msgs/msg/hand.h"
// Member `left_hand`
// Member `right_hand`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vojext_msgs__msg__Person__init(message_memory);
}

void Person__rosidl_typesupport_introspection_c__Person_fini_function(void * message_memory)
{
  vojext_msgs__msg__Person__fini(message_memory);
}

size_t Person__rosidl_typesupport_introspection_c__size_function__Hand__left_hand(
  const void * untyped_member)
{
  const vojext_msgs__msg__Hand__Sequence * member =
    (const vojext_msgs__msg__Hand__Sequence *)(untyped_member);
  return member->size;
}
...
{
  vojext_msgs__msg__Hand__Sequence * member =
    (vojext_msgs__msg__Hand__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  vojext_msgs__msg__Hand__Sequence * member =
    (vojext_msgs__msg__Hand__Sequence *)(untyped_member);
  vojext_msgs__msg__Hand__Sequence__fini(member);
  return vojext_msgs__msg__Hand__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember Person__rosidl_typesupport_introspection_c__Person_message_member_array[9] = {
  {
    ...
    offsetof(vojext_msgs__msg__Person, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__Person, result_dynamic_left),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__Person, result_dynamic_right),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__Person, result_static_left),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__Person, result_static_right),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__Person, final_result_left),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__Person, final_result_right),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__Person, left_hand),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__Person, right_hand),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Person__rosidl_typesupport_introspection_c__Person_message_members = {
  ...
  "Person",  // message name
  9,  // number of fields
  sizeof(vojext_msgs__msg__Person),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vojext_msgs, msg, Person)() {
