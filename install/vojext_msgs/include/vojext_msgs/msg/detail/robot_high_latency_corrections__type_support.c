...
#include <stddef.h>
#include "vojext_msgs/msg/detail/robot_high_latency_corrections__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vojext_msgs__msg__RobotHighLatencyCorrections__init(message_memory);
}
...
{
  vojext_msgs__msg__RobotHighLatencyCorrections__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember RobotHighLatencyCorrections__rosidl_typesupport_introspection_c__RobotHighLatencyCorrections_message_member_array[4] = {
  {
    ...
    offsetof(vojext_msgs__msg__RobotHighLatencyCorrections, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__RobotHighLatencyCorrections, action),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__RobotHighLatencyCorrections, description),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__RobotHighLatencyCorrections, cause),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers RobotHighLatencyCorrections__rosidl_typesupport_introspection_c__RobotHighLatencyCorrections_message_members = {
  ...
  4,  // number of fields
  sizeof(vojext_msgs__msg__RobotHighLatencyCorrections),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vojext_msgs, msg, RobotHighLatencyCorrections)() {
