...
#include <stddef.h>
#include "vojext_msgs/msg/detail/person_list__rosidl_typesupport_introspection_c.h"
...
// Member `person_list`
#include "vojext_msgs/msg/person.h"
// Member `person_list`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vojext_msgs__msg__PersonList__init(message_memory);
}

void PersonList__rosidl_typesupport_introspection_c__PersonList_fini_function(void * message_memory)
{
  vojext_msgs__msg__PersonList__fini(message_memory);
}

size_t PersonList__rosidl_typesupport_introspection_c__size_function__Person__person_list(
  const void * untyped_member)
{
  const vojext_msgs__msg__Person__Sequence * member =
    (const vojext_msgs__msg__Person__Sequence *)(untyped_member);
  return member->size;
}
...
{
  vojext_msgs__msg__Person__Sequence * member =
    (vojext_msgs__msg__Person__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  vojext_msgs__msg__Person__Sequence * member =
    (vojext_msgs__msg__Person__Sequence *)(untyped_member);
  vojext_msgs__msg__Person__Sequence__fini(member);
  return vojext_msgs__msg__Person__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember PersonList__rosidl_typesupport_introspection_c__PersonList_message_member_array[3] = {
  {
    ...
    offsetof(vojext_msgs__msg__PersonList, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__PersonList, image_header),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vojext_msgs__msg__PersonList, person_list),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers PersonList__rosidl_typesupport_introspection_c__PersonList_message_members = {
  ...
  3,  // number of fields
  sizeof(vojext_msgs__msg__PersonList),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vojext_msgs, msg, PersonList)() {
