...
{
  new (message_memory) april_msgs::msg::RobotHighLatencyCorrections(_init);
}

void RobotHighLatencyCorrections_fini_function(void * message_memory)
{
  auto typed_message = static_cast<april_msgs::msg::RobotHighLatencyCorrections *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotHighLatencyCorrections_message_member_array[4] = {
  {
    ...
    offsetof(april_msgs::msg::RobotHighLatencyCorrections, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::RobotHighLatencyCorrections, action),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::RobotHighLatencyCorrections, description),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::RobotHighLatencyCorrections, cause),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotHighLatencyCorrections_message_members = {
  ...
  4,  // number of fields
  sizeof(april_msgs::msg::RobotHighLatencyCorrections),
...
get_message_type_support_handle<april_msgs::msg::RobotHighLatencyCorrections>()
{
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::RobotHighLatencyCorrections_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, april_msgs, msg, RobotHighLatencyCorrections)() {
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::RobotHighLatencyCorrections_message_type_support_handle;
}
