...
#include <stddef.h>
#include "april_msgs/msg/detail/robot_arm__rosidl_typesupport_introspection_c.h"
...
#include "april_msgs/msg/detail/robot_arm__struct.h"
...
#include "april_msgs/msg/robot_arm_kinematic.h"
// Member `robotarmkinematic_list`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  april_msgs__msg__RobotArm__init(message_memory);
}

void RobotArm__rosidl_typesupport_introspection_c__RobotArm_fini_function(void * message_memory)
{
  april_msgs__msg__RobotArm__fini(message_memory);
}

size_t RobotArm__rosidl_typesupport_introspection_c__size_function__RobotArmKinematic__robotarmkinematic_list(
  const void * untyped_member)
{
  const april_msgs__msg__RobotArmKinematic__Sequence * member =
    (const april_msgs__msg__RobotArmKinematic__Sequence *)(untyped_member);
  return member->size;
}
...
{
  april_msgs__msg__RobotArmKinematic__Sequence * member =
    (april_msgs__msg__RobotArmKinematic__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  april_msgs__msg__RobotArmKinematic__Sequence * member =
    (april_msgs__msg__RobotArmKinematic__Sequence *)(untyped_member);
  april_msgs__msg__RobotArmKinematic__Sequence__fini(member);
  return april_msgs__msg__RobotArmKinematic__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember RobotArm__rosidl_typesupport_introspection_c__RobotArm_message_member_array[3] = {
  {
    ...
    offsetof(april_msgs__msg__RobotArm, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__RobotArm, state),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__RobotArm, robotarmkinematic_list),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers RobotArm__rosidl_typesupport_introspection_c__RobotArm_message_members = {
  ...
  3,  // number of fields
  sizeof(april_msgs__msg__RobotArm),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, april_msgs, msg, RobotArm)() {
