...
#ifndef APRIL_MSGS__MSG__DETAIL__HUMAN_MOTION__STRUCT_HPP_
#define APRIL_MSGS__MSG__DETAIL__HUMAN_MOTION__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__april_msgs__msg__HumanMotion __attribute__((deprecated))
#else
# define DEPRECATED__april_msgs__msg__HumanMotion __declspec(deprecated)
#endif
...
struct HumanMotion_
{
  ...
  // pointer types
  using RawPtr =
    april_msgs::msg::HumanMotion_<ContainerAllocator> *;
  using ConstRawPtr =
    const april_msgs::msg::HumanMotion_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<april_msgs::msg::HumanMotion_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<april_msgs::msg::HumanMotion_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      april_msgs::msg::HumanMotion_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<april_msgs::msg::HumanMotion_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<april_msgs::msg::HumanMotion_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<april_msgs::msg::HumanMotion_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<april_msgs::msg::HumanMotion_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__april_msgs__msg__HumanMotion
    std::shared_ptr<april_msgs::msg::HumanMotion_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__april_msgs__msg__HumanMotion
    std::shared_ptr<april_msgs::msg::HumanMotion_<ContainerAllocator> const>
...
using HumanMotion =
  april_msgs::msg::HumanMotion_<std::allocator<void>>;
...
#endif  // APRIL_MSGS__MSG__DETAIL__HUMAN_MOTION__STRUCT_HPP_
