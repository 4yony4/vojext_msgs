...
#ifndef APRIL_MSGS__MSG__DETAIL__HUMAN_MOTION__TRAITS_HPP_
#define APRIL_MSGS__MSG__DETAIL__HUMAN_MOTION__TRAITS_HPP_
...
inline void to_yaml(
  const april_msgs::msg::HumanMotion & msg,
...
inline std::string to_yaml(const april_msgs::msg::HumanMotion & msg)
{
...
template<>
inline const char * data_type<april_msgs::msg::HumanMotion>()
{
  return "april_msgs::msg::HumanMotion";
}

template<>
inline const char * name<april_msgs::msg::HumanMotion>()
{
  return "april_msgs/msg/HumanMotion";
}

template<>
struct has_fixed_size<april_msgs::msg::HumanMotion>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<april_msgs::msg::HumanMotion>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<april_msgs::msg::HumanMotion>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // APRIL_MSGS__MSG__DETAIL__HUMAN_MOTION__TRAITS_HPP_
