...
#include <stddef.h>
#include "april_msgs/msg/detail/symbolic_action__rosidl_typesupport_introspection_c.h"
...
// Member `grasp_facts`
#include "april_msgs/msg/grasp_facts.h"
// Member `grasp_facts`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  april_msgs__msg__SymbolicAction__init(message_memory);
}

void SymbolicAction__rosidl_typesupport_introspection_c__SymbolicAction_fini_function(void * message_memory)
{
  april_msgs__msg__SymbolicAction__fini(message_memory);
}

size_t SymbolicAction__rosidl_typesupport_introspection_c__size_function__GraspFacts__grasp_facts(
  const void * untyped_member)
{
  const april_msgs__msg__GraspFacts__Sequence * member =
    (const april_msgs__msg__GraspFacts__Sequence *)(untyped_member);
  return member->size;
}
...
{
  april_msgs__msg__GraspFacts__Sequence * member =
    (april_msgs__msg__GraspFacts__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  april_msgs__msg__GraspFacts__Sequence * member =
    (april_msgs__msg__GraspFacts__Sequence *)(untyped_member);
  april_msgs__msg__GraspFacts__Sequence__fini(member);
  return april_msgs__msg__GraspFacts__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember SymbolicAction__rosidl_typesupport_introspection_c__SymbolicAction_message_member_array[5] = {
  {
    ...
    offsetof(april_msgs__msg__SymbolicAction, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__SymbolicAction, action_type),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__SymbolicAction, target_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__SymbolicAction, grasp_facts),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__SymbolicAction, target_pose),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SymbolicAction__rosidl_typesupport_introspection_c__SymbolicAction_message_members = {
  ...
  5,  // number of fields
  sizeof(april_msgs__msg__SymbolicAction),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, april_msgs, msg, SymbolicAction)() {
