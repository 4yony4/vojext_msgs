...
{
  new (message_memory) april_msgs::msg::GraspFacts(_init);
}

void GraspFacts_fini_function(void * message_memory)
{
  auto typed_message = static_cast<april_msgs::msg::GraspFacts *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GraspFacts_message_member_array[4] = {
  {
    ...
    offsetof(april_msgs::msg::GraspFacts, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::GraspFacts, grasp_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::GraspFacts, grasp_location),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::GraspFacts, grasp_dimension),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GraspFacts_message_members = {
  ...
  4,  // number of fields
  sizeof(april_msgs::msg::GraspFacts),
...
get_message_type_support_handle<april_msgs::msg::GraspFacts>()
{
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::GraspFacts_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, april_msgs, msg, GraspFacts)() {
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::GraspFacts_message_type_support_handle;
}
