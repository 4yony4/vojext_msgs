...
{
  new (message_memory) april_msgs::msg::ObjectEstimatedPose(_init);
}

void ObjectEstimatedPose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<april_msgs::msg::ObjectEstimatedPose *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectEstimatedPose_message_member_array[5] = {
  {
    ...
    offsetof(april_msgs::msg::ObjectEstimatedPose, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::ObjectEstimatedPose, point_cloud),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::ObjectEstimatedPose, estimated_pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::ObjectEstimatedPose, id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::ObjectEstimatedPose, sclass),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectEstimatedPose_message_members = {
  ...
  5,  // number of fields
  sizeof(april_msgs::msg::ObjectEstimatedPose),
...
get_message_type_support_handle<april_msgs::msg::ObjectEstimatedPose>()
{
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectEstimatedPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, april_msgs, msg, ObjectEstimatedPose)() {
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectEstimatedPose_message_type_support_handle;
}
