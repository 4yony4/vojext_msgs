...
{
  new (message_memory) april_msgs::msg::RobotGraspingStrategies(_init);
}

void RobotGraspingStrategies_fini_function(void * message_memory)
{
  auto typed_message = static_cast<april_msgs::msg::RobotGraspingStrategies *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotGraspingStrategies_message_member_array[4] = {
  {
    ...
    offsetof(april_msgs::msg::RobotGraspingStrategies, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::RobotGraspingStrategies, type),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::RobotGraspingStrategies, location),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::RobotGraspingStrategies, timetolift),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotGraspingStrategies_message_members = {
  ...
  4,  // number of fields
  sizeof(april_msgs::msg::RobotGraspingStrategies),
...
get_message_type_support_handle<april_msgs::msg::RobotGraspingStrategies>()
{
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::RobotGraspingStrategies_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, april_msgs, msg, RobotGraspingStrategies)() {
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::RobotGraspingStrategies_message_type_support_handle;
}
