...
#include <stddef.h>
#include "april_msgs/msg/detail/tactile__rosidl_typesupport_introspection_c.h"
...
#include "april_msgs/msg/detail/tactile__struct.h"
...
static rosidl_typesupport_introspection_c__MessageMember Tactile__rosidl_typesupport_introspection_c__Tactile_message_member_array[3] = {
  {
    ...
    offsetof(april_msgs__msg__Tactile, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__Tactile, label),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__Tactile, temperature),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Tactile__rosidl_typesupport_introspection_c__Tactile_message_members = {
  ...
  3,  // number of fields
  sizeof(april_msgs__msg__Tactile),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, april_msgs, msg, Tactile)() {
