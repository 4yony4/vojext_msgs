...
#ifndef APRIL_MSGS__MSG__DETAIL__COMPONENT_STATUS__FUNCTIONS_H_
#define APRIL_MSGS__MSG__DETAIL__COMPONENT_STATUS__FUNCTIONS_H_
 ...
 * calls
 * april_msgs__msg__ComponentStatus__init().
...
/**
 * It calls
 * april_msgs__msg__ComponentStatus__fini()
 ...
 * april_msgs__msg__ComponentStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * april_msgs__msg__ComponentStatus__Sequence__fini()
 * on the array,
...
#endif  // APRIL_MSGS__MSG__DETAIL__COMPONENT_STATUS__FUNCTIONS_H_
