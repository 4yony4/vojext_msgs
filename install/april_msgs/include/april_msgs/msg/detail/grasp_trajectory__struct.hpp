...
#ifndef APRIL_MSGS__MSG__DETAIL__GRASP_TRAJECTORY__STRUCT_HPP_
#define APRIL_MSGS__MSG__DETAIL__GRASP_TRAJECTORY__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__april_msgs__msg__GraspTrajectory __attribute__((deprecated))
#else
# define DEPRECATED__april_msgs__msg__GraspTrajectory __declspec(deprecated)
#endif
...
struct GraspTrajectory_
{
  ...
  // pointer types
  using RawPtr =
    april_msgs::msg::GraspTrajectory_<ContainerAllocator> *;
  using ConstRawPtr =
    const april_msgs::msg::GraspTrajectory_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<april_msgs::msg::GraspTrajectory_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<april_msgs::msg::GraspTrajectory_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      april_msgs::msg::GraspTrajectory_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<april_msgs::msg::GraspTrajectory_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<april_msgs::msg::GraspTrajectory_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<april_msgs::msg::GraspTrajectory_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<april_msgs::msg::GraspTrajectory_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__april_msgs__msg__GraspTrajectory
    std::shared_ptr<april_msgs::msg::GraspTrajectory_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__april_msgs__msg__GraspTrajectory
    std::shared_ptr<april_msgs::msg::GraspTrajectory_<ContainerAllocator> const>
...
using GraspTrajectory =
  april_msgs::msg::GraspTrajectory_<std::allocator<void>>;
...
#endif  // APRIL_MSGS__MSG__DETAIL__GRASP_TRAJECTORY__STRUCT_HPP_
