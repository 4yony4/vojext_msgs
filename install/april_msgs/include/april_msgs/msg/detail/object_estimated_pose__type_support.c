...
static rosidl_typesupport_introspection_c__MessageMember ObjectEstimatedPose__rosidl_typesupport_introspection_c__ObjectEstimatedPose_message_member_array[5] = {
  {
    ...
    offsetof(april_msgs__msg__ObjectEstimatedPose, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__ObjectEstimatedPose, point_cloud),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__ObjectEstimatedPose, estimated_pose),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__ObjectEstimatedPose, id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__ObjectEstimatedPose, sclass),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ObjectEstimatedPose__rosidl_typesupport_introspection_c__ObjectEstimatedPose_message_members = {
  ...
  5,  // number of fields
  sizeof(april_msgs__msg__ObjectEstimatedPose),
