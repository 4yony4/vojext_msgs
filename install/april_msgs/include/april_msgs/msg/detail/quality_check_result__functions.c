...
april_msgs__msg__QualityCheckResult__init(april_msgs__msg__QualityCheckResult * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    april_msgs__msg__QualityCheckResult__fini(msg);
    return false;
  }
  // object_id
  // result
...
{
  april_msgs__msg__QualityCheckResult * msg = (april_msgs__msg__QualityCheckResult *)malloc(sizeof(april_msgs__msg__QualityCheckResult));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(april_msgs__msg__QualityCheckResult));
  bool success = april_msgs__msg__QualityCheckResult__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
april_msgs__msg__QualityCheckResult__Sequence__init(april_msgs__msg__QualityCheckResult__Sequence * array, size_t size)
{
  ...
  april_msgs__msg__QualityCheckResult * data = NULL;
  if (size) {
    data = (april_msgs__msg__QualityCheckResult *)calloc(size, sizeof(april_msgs__msg__QualityCheckResult));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = april_msgs__msg__QualityCheckResult__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        april_msgs__msg__QualityCheckResult__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
april_msgs__msg__QualityCheckResult__Sequence__fini(april_msgs__msg__QualityCheckResult__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      april_msgs__msg__QualityCheckResult__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  april_msgs__msg__QualityCheckResult__Sequence * array = (april_msgs__msg__QualityCheckResult__Sequence *)malloc(sizeof(april_msgs__msg__QualityCheckResult__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = april_msgs__msg__QualityCheckResult__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    april_msgs__msg__QualityCheckResult__Sequence__fini(array);
  }
  free(array);
}
...
april_msgs__msg__QualityCheckResult__Sequence__are_equal(const april_msgs__msg__QualityCheckResult__Sequence * lhs, const april_msgs__msg__QualityCheckResult__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!april_msgs__msg__QualityCheckResult__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  april_msgs__msg__QualityCheckResult__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(april_msgs__msg__QualityCheckResult);
    april_msgs__msg__QualityCheckResult * data =
      (april_msgs__msg__QualityCheckResult *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!april_msgs__msg__QualityCheckResult__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          april_msgs__msg__QualityCheckResult__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!april_msgs__msg__QualityCheckResult__copy(
