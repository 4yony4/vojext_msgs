...
#include <stddef.h>
#include "april_msgs/msg/detail/clustered_object__rosidl_typesupport_introspection_c.h"
...
#include "april_msgs/msg/detail/clustered_object__struct.h"
...
static rosidl_typesupport_introspection_c__MessageMember ClusteredObject__rosidl_typesupport_introspection_c__ClusteredObject_message_member_array[4] = {
  {
    ...
    offsetof(april_msgs__msg__ClusteredObject, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__ClusteredObject, clustered_point_cloud),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__ClusteredObject, id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__ClusteredObject, sclass),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ClusteredObject__rosidl_typesupport_introspection_c__ClusteredObject_message_members = {
  ...
  4,  // number of fields
  sizeof(april_msgs__msg__ClusteredObject),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, april_msgs, msg, ClusteredObject)() {
