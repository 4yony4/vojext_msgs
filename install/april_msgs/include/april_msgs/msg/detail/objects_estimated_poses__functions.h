...
#ifndef APRIL_MSGS__MSG__DETAIL__OBJECTS_ESTIMATED_POSES__FUNCTIONS_H_
#define APRIL_MSGS__MSG__DETAIL__OBJECTS_ESTIMATED_POSES__FUNCTIONS_H_
 ...
 * calls
 * april_msgs__msg__ObjectsEstimatedPoses__init().
...
/**
 * It calls
 * april_msgs__msg__ObjectsEstimatedPoses__fini()
 ...
 * april_msgs__msg__ObjectsEstimatedPoses__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * april_msgs__msg__ObjectsEstimatedPoses__Sequence__fini()
 * on the array,
...
#endif  // APRIL_MSGS__MSG__DETAIL__OBJECTS_ESTIMATED_POSES__FUNCTIONS_H_
