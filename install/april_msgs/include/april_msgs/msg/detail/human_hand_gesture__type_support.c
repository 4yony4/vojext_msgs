...
#include <stddef.h>
#include "april_msgs/msg/detail/human_hand_gesture__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember HumanHandGesture__rosidl_typesupport_introspection_c__HumanHandGesture_message_member_array[2] = {
  {
    ...
    offsetof(april_msgs__msg__HumanHandGesture, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__HumanHandGesture, recognized_gesture),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers HumanHandGesture__rosidl_typesupport_introspection_c__HumanHandGesture_message_members = {
  ...
  2,  // number of fields
  sizeof(april_msgs__msg__HumanHandGesture),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, april_msgs, msg, HumanHandGesture)() {
