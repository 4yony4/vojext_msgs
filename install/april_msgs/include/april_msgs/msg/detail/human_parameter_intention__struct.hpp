...
#ifndef APRIL_MSGS__MSG__DETAIL__HUMAN_PARAMETER_INTENTION__STRUCT_HPP_
#define APRIL_MSGS__MSG__DETAIL__HUMAN_PARAMETER_INTENTION__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__april_msgs__msg__HumanParameterIntention __attribute__((deprecated))
#else
# define DEPRECATED__april_msgs__msg__HumanParameterIntention __declspec(deprecated)
#endif
...
struct HumanParameterIntention_
{
  ...
  using _humanmotion_list_type =
    std::vector<april_msgs::msg::HumanMotion_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<april_msgs::msg::HumanMotion_<ContainerAllocator>>>;
  ...
  Type & set__humanmotion_list(
    const std::vector<april_msgs::msg::HumanMotion_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<april_msgs::msg::HumanMotion_<ContainerAllocator>>> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    april_msgs::msg::HumanParameterIntention_<ContainerAllocator> *;
  using ConstRawPtr =
    const april_msgs::msg::HumanParameterIntention_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<april_msgs::msg::HumanParameterIntention_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<april_msgs::msg::HumanParameterIntention_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      april_msgs::msg::HumanParameterIntention_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<april_msgs::msg::HumanParameterIntention_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<april_msgs::msg::HumanParameterIntention_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<april_msgs::msg::HumanParameterIntention_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<april_msgs::msg::HumanParameterIntention_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__april_msgs__msg__HumanParameterIntention
    std::shared_ptr<april_msgs::msg::HumanParameterIntention_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__april_msgs__msg__HumanParameterIntention
    std::shared_ptr<april_msgs::msg::HumanParameterIntention_<ContainerAllocator> const>
...
using HumanParameterIntention =
  april_msgs::msg::HumanParameterIntention_<std::allocator<void>>;
...
#endif  // APRIL_MSGS__MSG__DETAIL__HUMAN_PARAMETER_INTENTION__STRUCT_HPP_
