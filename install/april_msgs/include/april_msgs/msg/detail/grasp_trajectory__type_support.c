...
#include <stddef.h>
#include "april_msgs/msg/detail/grasp_trajectory__rosidl_typesupport_introspection_c.h"
...
#include "april_msgs/msg/detail/grasp_trajectory__struct.h"
...
static rosidl_typesupport_introspection_c__MessageMember GraspTrajectory__rosidl_typesupport_introspection_c__GraspTrajectory_message_member_array[4] = {
  {
    ...
    offsetof(april_msgs__msg__GraspTrajectory, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__GraspTrajectory, ee_frame_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__GraspTrajectory, hand_poses),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__GraspTrajectory, fingers_states),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers GraspTrajectory__rosidl_typesupport_introspection_c__GraspTrajectory_message_members = {
  ...
  4,  // number of fields
  sizeof(april_msgs__msg__GraspTrajectory),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, april_msgs, msg, GraspTrajectory)() {
