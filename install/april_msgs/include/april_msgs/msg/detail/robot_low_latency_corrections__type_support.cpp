...
{
  new (message_memory) april_msgs::msg::RobotLowLatencyCorrections(_init);
}

void RobotLowLatencyCorrections_fini_function(void * message_memory)
{
  auto typed_message = static_cast<april_msgs::msg::RobotLowLatencyCorrections *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotLowLatencyCorrections_message_member_array[2] = {
  {
    ...
    offsetof(april_msgs::msg::RobotLowLatencyCorrections, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::RobotLowLatencyCorrections, action),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotLowLatencyCorrections_message_members = {
  ...
  2,  // number of fields
  sizeof(april_msgs::msg::RobotLowLatencyCorrections),
...
get_message_type_support_handle<april_msgs::msg::RobotLowLatencyCorrections>()
{
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::RobotLowLatencyCorrections_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, april_msgs, msg, RobotLowLatencyCorrections)() {
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::RobotLowLatencyCorrections_message_type_support_handle;
}
