...
{
  new (message_memory) april_msgs::msg::ComponentStatus(_init);
}

void ComponentStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<april_msgs::msg::ComponentStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ComponentStatus_message_member_array[3] = {
  {
    ...
    offsetof(april_msgs::msg::ComponentStatus, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::ComponentStatus, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::ComponentStatus, msg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ComponentStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(april_msgs::msg::ComponentStatus),
...
get_message_type_support_handle<april_msgs::msg::ComponentStatus>()
{
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::ComponentStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, april_msgs, msg, ComponentStatus)() {
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::ComponentStatus_message_type_support_handle;
}
