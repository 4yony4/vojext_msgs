...
#include "april_msgs/msg/detail/symbolic_action__functions.h"
...
april_msgs__msg__SymbolicAction__init(april_msgs__msg__SymbolicAction * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    april_msgs__msg__SymbolicAction__fini(msg);
    return false;
  }
  // action_type
  ...
  // grasp_facts
  if (!april_msgs__msg__GraspFacts__Sequence__init(&msg->grasp_facts, 0)) {
    april_msgs__msg__SymbolicAction__fini(msg);
    return false;
  }
  // target_pose
...
april_msgs__msg__SymbolicAction__fini(april_msgs__msg__SymbolicAction * msg)
{
  ...
  // grasp_facts
  april_msgs__msg__GraspFacts__Sequence__fini(&msg->grasp_facts);
  // target_pose
...
april_msgs__msg__SymbolicAction__are_equal(const april_msgs__msg__SymbolicAction * lhs, const april_msgs__msg__SymbolicAction * rhs)
{
  ...
  // grasp_facts
  if (!april_msgs__msg__GraspFacts__Sequence__are_equal(
  ...
  april_msgs__msg__SymbolicAction * output)
{
  ...
  // grasp_facts
  if (!april_msgs__msg__GraspFacts__Sequence__copy(
...
{
  april_msgs__msg__SymbolicAction * msg = (april_msgs__msg__SymbolicAction *)malloc(sizeof(april_msgs__msg__SymbolicAction));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(april_msgs__msg__SymbolicAction));
  bool success = april_msgs__msg__SymbolicAction__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
april_msgs__msg__SymbolicAction__Sequence__init(april_msgs__msg__SymbolicAction__Sequence * array, size_t size)
{
  ...
  april_msgs__msg__SymbolicAction * data = NULL;
  if (size) {
    data = (april_msgs__msg__SymbolicAction *)calloc(size, sizeof(april_msgs__msg__SymbolicAction));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = april_msgs__msg__SymbolicAction__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        april_msgs__msg__SymbolicAction__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
april_msgs__msg__SymbolicAction__Sequence__fini(april_msgs__msg__SymbolicAction__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      april_msgs__msg__SymbolicAction__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  april_msgs__msg__SymbolicAction__Sequence * array = (april_msgs__msg__SymbolicAction__Sequence *)malloc(sizeof(april_msgs__msg__SymbolicAction__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = april_msgs__msg__SymbolicAction__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    april_msgs__msg__SymbolicAction__Sequence__fini(array);
  }
  free(array);
}
...
april_msgs__msg__SymbolicAction__Sequence__are_equal(const april_msgs__msg__SymbolicAction__Sequence * lhs, const april_msgs__msg__SymbolicAction__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!april_msgs__msg__SymbolicAction__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  april_msgs__msg__SymbolicAction__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(april_msgs__msg__SymbolicAction);
    april_msgs__msg__SymbolicAction * data =
      (april_msgs__msg__SymbolicAction *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!april_msgs__msg__SymbolicAction__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          april_msgs__msg__SymbolicAction__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!april_msgs__msg__SymbolicAction__copy(
