...
{
  new (message_memory) april_msgs::msg::ActionCommon(_init);
}

void ActionCommon_fini_function(void * message_memory)
{
  auto typed_message = static_cast<april_msgs::msg::ActionCommon *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ActionCommon_message_member_array[4] = {
  {
    ...
    offsetof(april_msgs::msg::ActionCommon, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::ActionCommon, action_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::ActionCommon, target_id),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::ActionCommon, force_limits),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ActionCommon_message_members = {
  ...
  4,  // number of fields
  sizeof(april_msgs::msg::ActionCommon),
...
get_message_type_support_handle<april_msgs::msg::ActionCommon>()
{
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::ActionCommon_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, april_msgs, msg, ActionCommon)() {
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::ActionCommon_message_type_support_handle;
}
