...
{
  new (message_memory) april_msgs::msg::HumanBehaviour(_init);
}

void HumanBehaviour_fini_function(void * message_memory)
{
  auto typed_message = static_cast<april_msgs::msg::HumanBehaviour *>(message_memory);
  typed_message->~HumanBehaviour();
}

size_t size_function__HumanBehaviour__humamgrasping_list(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<april_msgs::msg::HumanGraspingStrategies> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<april_msgs::msg::HumanGraspingStrategies> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<april_msgs::msg::HumanGraspingStrategies> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HumanBehaviour_message_member_array[3] = {
  {
    ...
    offsetof(april_msgs::msg::HumanBehaviour, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::HumanBehaviour, body_posture),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<april_msgs::msg::HumanGraspingStrategies>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::HumanBehaviour, humamgrasping_list),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HumanBehaviour_message_members = {
  ...
  3,  // number of fields
  sizeof(april_msgs::msg::HumanBehaviour),
...
get_message_type_support_handle<april_msgs::msg::HumanBehaviour>()
{
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::HumanBehaviour_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, april_msgs, msg, HumanBehaviour)() {
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::HumanBehaviour_message_type_support_handle;
}
