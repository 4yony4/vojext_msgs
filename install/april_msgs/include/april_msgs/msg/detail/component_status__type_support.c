...
#include <stddef.h>
#include "april_msgs/msg/detail/component_status__rosidl_typesupport_introspection_c.h"
...
#include "april_msgs/msg/detail/component_status__struct.h"
...
static rosidl_typesupport_introspection_c__MessageMember ComponentStatus__rosidl_typesupport_introspection_c__ComponentStatus_message_member_array[3] = {
  {
    ...
    offsetof(april_msgs__msg__ComponentStatus, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__ComponentStatus, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__ComponentStatus, msg),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ComponentStatus__rosidl_typesupport_introspection_c__ComponentStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(april_msgs__msg__ComponentStatus),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, april_msgs, msg, ComponentStatus)() {
