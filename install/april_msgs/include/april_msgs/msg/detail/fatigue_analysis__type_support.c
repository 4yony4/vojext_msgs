...
#include <stddef.h>
#include "april_msgs/msg/detail/fatigue_analysis__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember FatigueAnalysis__rosidl_typesupport_introspection_c__FatigueAnalysis_message_member_array[2] = {
  {
    ...
    offsetof(april_msgs__msg__FatigueAnalysis, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__FatigueAnalysis, fatigue_values),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers FatigueAnalysis__rosidl_typesupport_introspection_c__FatigueAnalysis_message_members = {
  ...
  2,  // number of fields
  sizeof(april_msgs__msg__FatigueAnalysis),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, april_msgs, msg, FatigueAnalysis)() {
