...
{
  new (message_memory) april_msgs::msg::ObjectsEstimatedPoses(_init);
}

void ObjectsEstimatedPoses_fini_function(void * message_memory)
{
  auto typed_message = static_cast<april_msgs::msg::ObjectsEstimatedPoses *>(message_memory);
...
{
  const auto * member = reinterpret_cast<const std::vector<april_msgs::msg::ObjectEstimatedPose> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<april_msgs::msg::ObjectEstimatedPose> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<april_msgs::msg::ObjectEstimatedPose> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectsEstimatedPoses_message_member_array[2] = {
  {
    ...
    offsetof(april_msgs::msg::ObjectsEstimatedPoses, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<april_msgs::msg::ObjectEstimatedPose>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::ObjectsEstimatedPoses, objects_estimated_poses),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectsEstimatedPoses_message_members = {
  ...
  2,  // number of fields
  sizeof(april_msgs::msg::ObjectsEstimatedPoses),
...
get_message_type_support_handle<april_msgs::msg::ObjectsEstimatedPoses>()
{
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectsEstimatedPoses_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, april_msgs, msg, ObjectsEstimatedPoses)() {
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectsEstimatedPoses_message_type_support_handle;
}
