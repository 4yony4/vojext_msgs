...
#include <stddef.h>
#include "april_msgs/msg/detail/human_parameter_intention__rosidl_typesupport_introspection_c.h"
...
// Member `humanmotion_list`
#include "april_msgs/msg/detail/human_motion__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  april_msgs__msg__HumanParameterIntention__init(message_memory);
}
...
{
  april_msgs__msg__HumanParameterIntention__fini(message_memory);
}

size_t HumanParameterIntention__rosidl_typesupport_introspection_c__size_function__HumanMotion__humanmotion_list(
  const void * untyped_member)
{
  const april_msgs__msg__HumanMotion__Sequence * member =
    (const april_msgs__msg__HumanMotion__Sequence *)(untyped_member);
  return member->size;
}
...
{
  april_msgs__msg__HumanMotion__Sequence * member =
    (april_msgs__msg__HumanMotion__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  april_msgs__msg__HumanMotion__Sequence * member =
    (april_msgs__msg__HumanMotion__Sequence *)(untyped_member);
  april_msgs__msg__HumanMotion__Sequence__fini(member);
  return april_msgs__msg__HumanMotion__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember HumanParameterIntention__rosidl_typesupport_introspection_c__HumanParameterIntention_message_member_array[6] = {
  {
    ...
    offsetof(april_msgs__msg__HumanParameterIntention, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__HumanParameterIntention, motion_prediction),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__HumanParameterIntention, engagement_level),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__HumanParameterIntention, cognitive_level),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__HumanParameterIntention, mood_level),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__HumanParameterIntention, humanmotion_list),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers HumanParameterIntention__rosidl_typesupport_introspection_c__HumanParameterIntention_message_members = {
  ...
  6,  // number of fields
  sizeof(april_msgs__msg__HumanParameterIntention),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, april_msgs, msg, HumanParameterIntention)() {
  ...
  HumanParameterIntention__rosidl_typesupport_introspection_c__HumanParameterIntention_message_member_array[5].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, april_msgs, msg, HumanMotion)();
