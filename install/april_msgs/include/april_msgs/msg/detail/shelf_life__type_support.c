...
#include <stddef.h>
#include "april_msgs/msg/detail/shelf_life__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember ShelfLife__rosidl_typesupport_introspection_c__ShelfLife_message_member_array[3] = {
  {
    ...
    offsetof(april_msgs__msg__ShelfLife, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__ShelfLife, object_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__ShelfLife, shelf_life),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ShelfLife__rosidl_typesupport_introspection_c__ShelfLife_message_members = {
  ...
  3,  // number of fields
  sizeof(april_msgs__msg__ShelfLife),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, april_msgs, msg, ShelfLife)() {
