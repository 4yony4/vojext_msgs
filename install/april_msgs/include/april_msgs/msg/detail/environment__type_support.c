...
#include <stddef.h>
#include "april_msgs/msg/detail/environment__rosidl_typesupport_introspection_c.h"
...
#include "april_msgs/msg/detail/environment__struct.h"
...
// Member `objects_list`
#include "april_msgs/msg/physical_object.h"
// Member `objects_list`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  april_msgs__msg__Environment__init(message_memory);
}

void Environment__rosidl_typesupport_introspection_c__Environment_fini_function(void * message_memory)
{
  april_msgs__msg__Environment__fini(message_memory);
}

size_t Environment__rosidl_typesupport_introspection_c__size_function__PhysicalObject__objects_list(
  const void * untyped_member)
{
  const april_msgs__msg__PhysicalObject__Sequence * member =
    (const april_msgs__msg__PhysicalObject__Sequence *)(untyped_member);
  return member->size;
}
...
{
  april_msgs__msg__PhysicalObject__Sequence * member =
    (april_msgs__msg__PhysicalObject__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  april_msgs__msg__PhysicalObject__Sequence * member =
    (april_msgs__msg__PhysicalObject__Sequence *)(untyped_member);
  april_msgs__msg__PhysicalObject__Sequence__fini(member);
  return april_msgs__msg__PhysicalObject__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember Environment__rosidl_typesupport_introspection_c__Environment_message_member_array[4] = {
  {
    ...
    offsetof(april_msgs__msg__Environment, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__Environment, timestamp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__Environment, semantictag),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__Environment, objects_list),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Environment__rosidl_typesupport_introspection_c__Environment_message_members = {
  ...
  4,  // number of fields
  sizeof(april_msgs__msg__Environment),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, april_msgs, msg, Environment)() {
