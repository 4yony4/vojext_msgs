...
#include <stddef.h>
#include "april_msgs/msg/detail/emergency__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Emergency__rosidl_typesupport_introspection_c__Emergency_message_member_array[2] = {
  {
    ...
    offsetof(april_msgs__msg__Emergency, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs__msg__Emergency, emergency_label),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Emergency__rosidl_typesupport_introspection_c__Emergency_message_members = {
  ...
  2,  // number of fields
  sizeof(april_msgs__msg__Emergency),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, april_msgs, msg, Emergency)() {
