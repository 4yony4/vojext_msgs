...
{
  new (message_memory) april_msgs::msg::HumanHandGesture(_init);
}

void HumanHandGesture_fini_function(void * message_memory)
{
  auto typed_message = static_cast<april_msgs::msg::HumanHandGesture *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HumanHandGesture_message_member_array[2] = {
  {
    ...
    offsetof(april_msgs::msg::HumanHandGesture, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(april_msgs::msg::HumanHandGesture, recognized_gesture),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HumanHandGesture_message_members = {
  ...
  2,  // number of fields
  sizeof(april_msgs::msg::HumanHandGesture),
...
get_message_type_support_handle<april_msgs::msg::HumanHandGesture>()
{
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::HumanHandGesture_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, april_msgs, msg, HumanHandGesture)() {
  return &::april_msgs::msg::rosidl_typesupport_introspection_cpp::HumanHandGesture_message_type_support_handle;
}
