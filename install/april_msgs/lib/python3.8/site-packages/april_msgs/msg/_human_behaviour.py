...
class Metaclass_HumanBehaviour(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from april_msgs.msg import HumanGraspingStrategies
...
class HumanBehaviour(metaclass=Metaclass_HumanBehaviour):
    ...
    _fields_and_field_types = {
        ...
        'body_posture': 'string',
        'humamgrasping_list': 'sequence<april_msgs/HumanGraspingStrategies>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['april_msgs', 'msg'], 'HumanGraspingStrategies')),  # noqa: E501
    )
