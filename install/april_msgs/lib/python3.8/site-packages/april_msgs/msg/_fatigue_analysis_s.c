...
bool april_msgs__msg__fatigue_analysis__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("april_msgs.msg._fatigue_analysis.FatigueAnalysis", full_classname_dest, 48) == 0);
  }
  april_msgs__msg__FatigueAnalysis * ros_message = _ros_message;
  {  // header
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * april_msgs__msg__fatigue_analysis__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of FatigueAnalysis */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("april_msgs.msg._fatigue_analysis");
  ...
  april_msgs__msg__FatigueAnalysis * ros_message = (april_msgs__msg__FatigueAnalysis *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
