    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'april_msgs.msg.DetectedObjects')
            logger.debug(
            ...
            from april_msgs.msg import DetectedObject
...
class DetectedObjects(metaclass=Metaclass_DetectedObjects):
    ...
    _fields_and_field_types = {
        ...
        'detected_objects': 'sequence<april_msgs/DetectedObject>',
        'rgb_image': 'sensor_msgs/Image',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['april_msgs', 'msg'], 'DetectedObject')),  # noqa: E501
