...
bool april_msgs__msg__grasp_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("april_msgs.msg._grasp_trajectory.GraspTrajectory", full_classname_dest, 48) == 0);
  }
  april_msgs__msg__GraspTrajectory * ros_message = _ros_message;
  {  // header
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * april_msgs__msg__grasp_trajectory__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of GraspTrajectory */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("april_msgs.msg._grasp_trajectory");
  ...
  april_msgs__msg__GraspTrajectory * ros_message = (april_msgs__msg__GraspTrajectory *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
