...
class Metaclass_RobotHand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from april_msgs.msg import RobotHandKinematic
...
class RobotHand(metaclass=Metaclass_RobotHand):
    ...
    _fields_and_field_types = {
        ...
        'state': 'string',
        'robothandkinematic_list': 'sequence<april_msgs/RobotHandKinematic>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['april_msgs', 'msg'], 'RobotHandKinematic')),  # noqa: E501
    )
