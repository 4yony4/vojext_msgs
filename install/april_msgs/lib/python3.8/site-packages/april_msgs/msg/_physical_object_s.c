...
bool april_msgs__msg__physical_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("april_msgs.msg._physical_object.PhysicalObject", full_classname_dest, 46) == 0);
  }
  april_msgs__msg__PhysicalObject * ros_message = _ros_message;
  {  // header
...
PyObject * april_msgs__msg__physical_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("april_msgs.msg._physical_object");
  ...
  april_msgs__msg__PhysicalObject * ros_message = (april_msgs__msg__PhysicalObject *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
