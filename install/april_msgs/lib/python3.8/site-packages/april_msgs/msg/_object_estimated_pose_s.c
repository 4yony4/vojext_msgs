...
bool april_msgs__msg__object_estimated_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("april_msgs.msg._object_estimated_pose.ObjectEstimatedPose", full_classname_dest, 57) == 0);
  }
  april_msgs__msg__ObjectEstimatedPose * ros_message = _ros_message;
  {  // header
...
PyObject * april_msgs__msg__object_estimated_pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("april_msgs.msg._object_estimated_pose");
  ...
  april_msgs__msg__ObjectEstimatedPose * ros_message = (april_msgs__msg__ObjectEstimatedPose *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
