...
bool april_msgs__msg__bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("april_msgs.msg._bounding_box.BoundingBox", full_classname_dest, 40) == 0);
  }
  april_msgs__msg__BoundingBox * ros_message = _ros_message;
  {  // header
...
PyObject * april_msgs__msg__bounding_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("april_msgs.msg._bounding_box");
  ...
  april_msgs__msg__BoundingBox * ros_message = (april_msgs__msg__BoundingBox *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
