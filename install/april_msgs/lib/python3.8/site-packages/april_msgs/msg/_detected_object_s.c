...
bool april_msgs__msg__detected_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("april_msgs.msg._detected_object.DetectedObject", full_classname_dest, 46) == 0);
  }
  april_msgs__msg__DetectedObject * ros_message = _ros_message;
  {  // header
  ...
  {  // bounding_box
    ...
    if (!april_msgs__msg__bounding_box__convert_from_py(field, &ros_message->bounding_box)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * april_msgs__msg__detected_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("april_msgs.msg._detected_object");
  ...
  april_msgs__msg__DetectedObject * ros_message = (april_msgs__msg__DetectedObject *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
  ...
  {  // bounding_box
    PyObject * field = NULL;
    field = april_msgs__msg__bounding_box__convert_to_py(&ros_message->bounding_box);
    if (!field) {
      return NULL;
    }
    {
