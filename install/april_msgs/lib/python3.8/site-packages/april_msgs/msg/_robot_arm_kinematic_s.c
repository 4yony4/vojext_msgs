...
bool april_msgs__msg__robot_arm_kinematic__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("april_msgs.msg._robot_arm_kinematic.RobotArmKinematic", full_classname_dest, 53) == 0);
  }
  april_msgs__msg__RobotArmKinematic * ros_message = _ros_message;
  {  // header
...
PyObject * april_msgs__msg__robot_arm_kinematic__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("april_msgs.msg._robot_arm_kinematic");
  ...
  april_msgs__msg__RobotArmKinematic * ros_message = (april_msgs__msg__RobotArmKinematic *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
