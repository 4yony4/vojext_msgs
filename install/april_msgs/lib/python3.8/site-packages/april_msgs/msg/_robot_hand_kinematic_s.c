...
bool april_msgs__msg__robot_hand_kinematic__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("april_msgs.msg._robot_hand_kinematic.RobotHandKinematic", full_classname_dest, 55) == 0);
  }
  april_msgs__msg__RobotHandKinematic * ros_message = _ros_message;
  {  // header
...
PyObject * april_msgs__msg__robot_hand_kinematic__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("april_msgs.msg._robot_hand_kinematic");
  ...
  april_msgs__msg__RobotHandKinematic * ros_message = (april_msgs__msg__RobotHandKinematic *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
