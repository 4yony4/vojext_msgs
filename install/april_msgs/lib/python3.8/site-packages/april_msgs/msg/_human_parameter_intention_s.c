...
bool april_msgs__msg__human_motion__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * april_msgs__msg__human_motion__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool april_msgs__msg__human_parameter_intention__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("april_msgs.msg._human_parameter_intention.HumanParameterIntention", full_classname_dest, 65) == 0);
  }
  april_msgs__msg__HumanParameterIntention * ros_message = _ros_message;
  {  // header
  ...
  {  // humanmotion_list
    ...
    if (!april_msgs__msg__HumanMotion__Sequence__init(&(ros_message->humanmotion_list), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create april_msgs__msg__HumanMotion__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    april_msgs__msg__HumanMotion * dest = ros_message->humanmotion_list.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!april_msgs__msg__human_motion__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * april_msgs__msg__human_parameter_intention__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of HumanParameterIntention */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("april_msgs.msg._human_parameter_intention");
  ...
  april_msgs__msg__HumanParameterIntention * ros_message = (april_msgs__msg__HumanParameterIntention *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
  ...
  {  // humanmotion_list
    ...
    april_msgs__msg__HumanMotion * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->humanmotion_list.data[i]);
      PyObject * pyitem = april_msgs__msg__human_motion__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
