...
bool april_msgs__msg__grasp_facts__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * april_msgs__msg__grasp_facts__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool april_msgs__msg__symbolic_action__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("april_msgs.msg._symbolic_action.SymbolicAction", full_classname_dest, 46) == 0);
  }
  april_msgs__msg__SymbolicAction * ros_message = _ros_message;
  {  // header
  ...
  {  // grasp_facts
    ...
    if (!april_msgs__msg__GraspFacts__Sequence__init(&(ros_message->grasp_facts), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create april_msgs__msg__GraspFacts__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    april_msgs__msg__GraspFacts * dest = ros_message->grasp_facts.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!april_msgs__msg__grasp_facts__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * april_msgs__msg__symbolic_action__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of SymbolicAction */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("april_msgs.msg._symbolic_action");
  ...
  april_msgs__msg__SymbolicAction * ros_message = (april_msgs__msg__SymbolicAction *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
  ...
  {  // grasp_facts
    ...
    april_msgs__msg__GraspFacts * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->grasp_facts.data[i]);
      PyObject * pyitem = april_msgs__msg__grasp_facts__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
